...
-- create table group_details (id serial primary key, title text, description text, venue_id integer, max_capacity integer, creator_id integer, meeting_date date, meeting_time time, is_deleted boolean default false, created_at timestamptz not null default now());
